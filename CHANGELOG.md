...
- Adopt conservative weights (better returns, worse drawdowns)
- Make a moderate adjustment (reduce realized_vol_60d from 15% to 5%)
- Keep current weights (most robust risk-adjusted OOS performance)
